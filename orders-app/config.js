...
export const config = {
  ...
  server: {
    ...
    /**
     * טוקן אורח — רואה הכל, **אינו משנה סטטוס**.
     *
     * ⚠️ הסיבה שזו הפרדה ולא נוחות: שינוי סטטוס ב-WooCommerce **שולח מייל
     * אוטומטי ללקוח**. מי שמקבל את הכתובת כדי "לשחק ולנסות" עלול לשלוח
     * בטעות הודעת "ההזמנה הושלמה" ללקוח אמיתי, וזה בלתי הפיך. הטוקן הזה
     * גם ניתן לביטול בנפרד, בלי לגעת בגישה של דרור.
     */
    guestToken: pick('ORDERS_GUEST_TOKEN'),
